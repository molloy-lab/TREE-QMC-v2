...
"              number of artificial taxa in the subproblem, number of elements\n"
"              in f, number of pruned elements in f, number of zeroes in f, \n"
"              the set of species in the subproblem)\n"
